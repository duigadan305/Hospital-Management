...
const TreatmentStep2 = (treatmentDetail) => {
  ...
  const handleSave = async (e) => {
    e.preventDefault();
    DoctorApiService.deleteTreatmentService(
      treatmentDetail.treatmentDetail.appointment.id
    );
    for (const item of selectedServices) {
      ...
      try {
        ...
        const response = await DoctorApiService.treatAppointmentServiceStep1(
          servData
        );
