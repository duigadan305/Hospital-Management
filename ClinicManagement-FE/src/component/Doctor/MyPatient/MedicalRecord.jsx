        ...
        },
        {
            ...
            render: (record) => {
                ...
                const fileBlob = new Blob([new Uint8Array(record.fileContent)], {
                    type: imageTypes.includes(fileType) ? `image/${fileType}` : 'application/octet-stream',
                });
        ...
        <>
            <div className="col-lg-8 offset-lg-2">
                <div className="invoice-content">
                            ...
                            <div className="col-md-12">
                                <div className="invoice-info" >
                                    <div style={{marginBottom:'30px'}}>
                                        <strong className="customer-text text-secondary" >BỆNH SỬ</strong>
                                    </div>
                                ...
                                <div className="invoice-info border-top border-2" style={{paddingTop:'20px'}}>
                                    <div style={{marginBottom:'30px'}}>
                                        <strong className="customer-text text-secondary" >CHỈ SỐ SINH TỒN</strong>
                                    </div>
                                    <div className="invoice-details invoice-details-two">
                                        <div className="d-flex justify-content-between patient-name">
                                            <div>
                                                ...
                                                <div>
                                                    <p className=""><strong>Mạch:</strong> {treatDetailData.vitalSign?.pulse} bpm</p> 
                                                    <p className=""><strong>Nhiệt độ:</strong> {treatDetailData.vitalSign?.temperature} °C</p> 
                                                    <p className=""><strong>Nhịp thở:</strong> {treatDetailData.vitalSign?.respiratoryRate} bpm</p> 
                                                </div>
                                            </div>
                                            <div style={{paddingTop:''}}>
                                                <p className=""><strong>Huyết áp:</strong> {treatDetailData.vitalSign?.bloodPressure} mmHg</p> 
                                                <p className=""><strong>Chỉ số Oxy:</strong> {treatDetailData.vitalSign?.oxygen} %</p> 
                                            </div>
                                            <div style={{paddingTop:''}}>
                                                <p className=""><strong>Chiều cao:</strong> {treatDetailData.vitalSign?.height} cm</p> 
                                                <p className=""><strong>Cân nặng:</strong> {treatDetailData.vitalSign?.weight} kg</p> 
                                            </div>
                                        </div>
                                    </div>
                                </div>   
                                ...
                                <div className="invoice-info border-top border-2" style={{paddingTop:'20px'}}>
                                    <div style={{marginBottom:'30px'}}>
                                        <strong className="customer-text text-secondary" >KHÁM BỘ PHẬN</strong>
                                    </div>
                                    <div className="invoice-details invoice-details-two">
                                        <div className="d-flex justify-content-between patient-name">
                                            <div>
                                ...
                                <div className="invoice-info border-top border-2" style={{paddingTop:'20px'}}>
                                    <div style={{marginBottom:'30px'}}>
                                        <strong className="customer-text text-secondary" >KHÁM TỔNG QUÁT</strong>
                                    </div>
                                    <div className="invoice-details invoice-details-two">
                                        <div className="d-flex justify-content-between patient-name">
                                            <div>
                    ...
                    <div className="invoice-item invoice-table-wrap">
                        <div className="row border-top border-2" style={{paddingLeft: '12px'}}>
                            ...
                            <div style={{ marginTop:'30px'}}>
                                        <strong className="customer-text text-secondary" >KẾT QUẢ XÉT NGHIỆM</strong>
                                    </div>
                                    <Table
                    ...
                    <div className="invoice-item invoice-table-wrap" style={{marginTop: '20px'}}>
                    <Link to={state.from}>
