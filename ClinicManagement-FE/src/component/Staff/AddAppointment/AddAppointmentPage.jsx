...
import AddSelectApppointment from "./AddSelectApppointment";
...
const AddAppointmentPage = () => {
  ...
  const handleConfirmSchedule = async (e) => {
    ...
    try {
      ...
      const response = await StaffApiService.addAppointment(apData);
          ...
          <div className="text-end mx-3">
            {current < steps.length - 1 && (
              <Button
                ...
                disabled={
                  current === 0
                    ? selectedDoctor && selectTime
                      ? false
                      : true
                    : (patientData ? false : true) || !selectTime
                }
                onClick={() => next()}
              >
                Tiếp
