...
const MedicalRecordGeneral = () => {
  ...
  useEffect(() => {
    const fetchAppointment = async () => {
      try {
        ...
        const appData = apData.appointmentList.sort(
          (a, b) =>
        ...
        const treatDetails = allData.flatMap(
          (record) => record.treatmentDetail
        );
        const services = allData.flatMap(
          (record) => record.treatmentServiceList
        );
        const prescriptions = allData.flatMap(
          (record) => record.prescriptionList
        );
  ...
  const apHistoryColumns = [
      ...
      render: function (treatDetailData) {
        return (
          <div style={{ textAlign: "left" }}>
            {treatDetailData.appointment.appointmentTime}
          </div>
        );
      },
    },
    {
      ...
      render: function (treatDetailData) {
        return (
          <div style={{ textAlign: "left" }}>
            {treatDetailData.priliminaryDiagnosis}
          </div>
        );
      },
    },
    {
      ...
      render: function (treatDetailData) {
        return (
          <div style={{ textAlign: "left" }}>
            {treatDetailData.finallyDiagnosis}
          </div>
        );
      },
    },
  ...
  const items = [
    ...
    },
    {
      ...
      children: <VitalSignChart treatDetailData={treatDetailData} />,
    },
    {
      key: "3",
      label: "Kết quả xét nghiệm",
      children: <ServiceResult serviceData={serviceData} />,
    },
    {
      key: "4",
      label: "Đơn thuốc",
      children: <PrescriptionList prescriptionData={prescriptionData} />,
    },
  ];
