        ...
        <>
            ...
            <header id="header" className={`fixed-top ${!show && "stickyHeader"}`}>
                <div className="container d-flex align-items-center">
                    ...
                    <Link to={isAuthenticated?'/appointment':'/login'} state={isAuthenticated ? null : { from: '/appointment'}} className="appointment-btn scrollto"><span className="d-none d-md-inline">Make an</span> Appointment</Link>
                </div>
            </header>
        </>
    )
