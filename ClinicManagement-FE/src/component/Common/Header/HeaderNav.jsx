    ...
    return (
        <>
            <nav id="navbar" className="navbar order-last order-lg-0">
                <ul>
                    {(Object.keys(data).length === 0 || data.role === "USER") && (<li><NavLink to={'/'} className={({ isActive }) => isActive ? "nav-link scrollto active" : ""}>Trang chủ</NavLink></li>)}
                    ...
                    {(Object.keys(data).length === 0 || data.role === "USER") && (<li><NavLink to={'/doctors'} className={({ isActive }) => isActive ? "nav-link scrollto active" : ""}>Bác sĩ</NavLink></li>)}
                    {(Object.keys(data).length === 0 || data.role === "USER") && (<li><NavLink to={'/contact'} className={({ isActive }) => isActive ? "nav-link scrollto active" : ""}>Liên hệ</NavLink></li>)}
