...
const SignUp = ({ setSignUp }) => {
    ...
    return (
        <form className="sign-up-form" onSubmit={hanldeOnSubmit}>
            ...
            >
                {loading ? <Spinner animation="border" variant="info" /> : "Đăng ký"}
            </button>
            {
                formData.password && 
            <div className="password-validatity mx-auto">
                ...
                <div style={emailError.emailError ? { color: "green" } : { color: "red" }}>
                    <p>{passwordValidation.numeric ? <FaCheck /> : <FaTimes />}
                        <span className="ms-2">Email phải đúng định dạng</span></p>
                </div>
            ...
            <p className="social-text">Đăng ký với tài khoản Google</p>
            <SocialSignUp />
        </form>
