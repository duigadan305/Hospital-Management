    ...
    useEffect(() => {
        const fetchAppointment = async () => {
            ...
            if(doctorData){
                ...
                const appData = data.appointmentList
                .sort((a, b) => 
            ...
            render: function (appointmentData) {
                return (
                    <div className='d-flex gap-2'>
                            ...
                            <Button onClick={() => showModal(appointmentData?.id)} type="primary" shape="circle" icon={<FaEye />} size="small" />
                            <Modal
                                                ...
                                                <div className='row'>
                                                    ...
                                                    <div mb-3v className="col-md-6">
                                                        <div className="form-group card-label mb-3">
                                                            ...
                                                            <input className="form-control" value={apData.patient?.user?.name || ''} type="text" readOnly name='name' />
                                                        </div>
                                                    </div>
                                                    <div mb-3v className="col-md-6">
                                                        <div className="form-group card-label mb-3">
                                                            <label htmlFor="card_name">Email</label>
                                                            <input className="form-control" value={apData.patient?.user?.email || ''} type="text" readOnly name='email' />
                                                        </div>
                                                    </div>
                                                    <div mb-3v className="col-md-4">
                                                        <div className="form-group card-label mb-3">
                                                            <label htmlFor="card_name">Điện thoại</label>
                                                            <input className="form-control" value={apData.patient?.user?.phone || ''} type="text" readOnly name='phone' />
                                                        </div>
                                                    </div>
                                                    <div mb-3v className="col-md-4">
                                                        <div className="form-group card-label mb-3">
                                                            <label htmlFor="card_name">Ngày sinh</label>
                                                            <input className="form-control" value={apData.patient?.dob || ''} type="date" readOnly name='dob' />
                                                        </div>
                                                    </div>
                                                    <div mb-3v className="col-md-4">
                                                        <div className="form-group card-label mb-3">
                                                            <label htmlFor="card_name">Giới tính</label>
                                                            <input className="form-control" value={apData.patient?.gender || ''} type="text" readOnly name='gender' />
                                                        </div>
                                                    </div>
                                                    <div mb-3v className="col-md-6">
                                                        <div className="form-group card-label mb-3">
                                                            <label htmlFor="card_name">Dân tộc</label>
                                                            <input className="form-control" value={apData.patient?.ethnicity || ''} type="text" readOnly name='ethnicity' />
                                                        </div>
                                                    </div>
                                                    <div mb-3v className="col-md-6">
                                                        <div className="form-group card-label mb-3">
                                                            <label htmlFor="card_name">Nghề nghiệp</label>
                                                            <input className="form-control" value={apData.patient?.job || ''} type="text" readOnly name='job' />
                                                        </div>
                                                    </div>
                                                    <div mb-3v className="col-md-6">
                                                        <div className="form-group card-label mb-3">
                                                            <label htmlFor="card_name">Nơi làm việc</label>
                                                            <input className="form-control" value={apData.patient?.workPlace || ''} type="text" readOnly name='workPlace' />
                                                        </div>
                                                    </div>
                                                    <div mb-3v className="col-md-6">
                                                        <div className="form-group card-label mb-3">
                                                            <label htmlFor="card_name">Số BHYT</label>
                                                            <input className="form-control" value={apData.patient?.healthInsuranceNumber || ''} type="text" readOnly name='healthInsuranceNumber' />
                                                        </div>
                                                    </div>
                                                </div>                                  
                                            </div>
                                            ...
                                            <div className="rounded p-3" style={{ background: "#f8f9fa" }}>       
                                                ...
                                                <div className="booking-item-wrap">
                                                    <ul className="booking-date">
                                                        <li>Bác sĩ phụ trách <span>{apData.doctor?.user?.name}</span></li>
                                                        <li>Thời gian <span>{apData.appointmentTime}</span></li>
                                                        <li>Lý do khám <span>{apData.reason}</span></li>
                                                    </ul>
                            ...
                            </Modal>
                        {
                            appointmentData.status === 'Accepted'
                                ...
                                <Link to={`/treatment/${appointmentData?.id}`}>
                                    <Button type="primary" icon={<FaBriefcaseMedical />} size="small">Khám bệnh</Button>
                                </Link>
                        ...
                        }
                        {
                            appointmentData?.status === 'Pended' &&
                            <>
                                <Button type="primary" icon={<FaCheck />} size="small" onClick={() => updatedApppointmentStatus(appointmentData, 'Accepted')}>Chấp nhận</Button>
                                <Button type='primary' icon={<FaTimes />} size='small' danger onClick={() => updatedApppointmentStatus(appointmentData, 'Cancel')}>Hủy</Button>
                            </>
                        }
                    </div>
                )
